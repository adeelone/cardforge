  ...
  return (
    <main className="page guide-page">
      ...
      <section className="guide-steps">
        ...
        <article><span>3</span><Link2 size={20} /><h2>Copy and send</h2><p>The filtered card is compressed into the link. No upload or CardForge account is involved.</p></article>
